package com.role.play.skills.commands;

import com.mojang.authlib.Agent;
import com.role.play.skills.utilities.RecipesResetCommandProfileLookupCallback;
...
public class RecipesResetCommand extends CommandBase
{
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException
    {
        if (args == null || args.length < 1) {
            sender.sendMessage(
                    new TextComponentTranslation("role.play.skills.command.reset.help", COMMAND_NAME)
            );
            return;
        }
